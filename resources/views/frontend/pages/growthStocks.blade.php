            ...
            <div class="row">
                <div class="col-12 mb-4">
                    <div class="card shadow border-0 p-0">
                        <div class="card-body">
                            <p>Выбирайте акции российских компаний с повышенным потенциалом роста одновременно по <b>средним значениям за 5 лет</b> и <b>текущим показателям</b>. Это избавляет вас от монотонного ручного сбора и анализа данных.</p>
                            <p>Фильтр уже использует рекомендованные настройки. <b><a href="{{route('frontend.multiplicators')}}" class="text-secondary">Изучайте мультипликаторы</a></b> и смягчайте настройки или делайте их строже, в зависимости от своих целей, а также сравнивайте компании по секторам.</p>
                            <p>Выбрав компанию - изучите ее самостоятельно более детально.</p>
                        </div>
                    </div>
                </div>
            </div>
