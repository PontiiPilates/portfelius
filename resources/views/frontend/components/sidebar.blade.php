...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                <a href="{{ route('home') }}" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img class="icon icon-xs me-2" src="/assets/img/brand/light.svg" height="20" width="20" alt="logo">
                    </span>
                    <span class="mt-1 ms-1 sidebar-text"><b>{{ env('APP_NAME') }}</b></span>
                </a>
            </li>
            {{-- Home --}}
            ...
            {{-- Multiplicators --}}
            <li class="nav-item">
                <a href="{{ route('frontend.multiplicators', ['year' => now()->subYear()->isoFormat('YYYY'), 'sort_by' => 'revenue']) }}" class="nav-link">
                    <span class="sidebar-icon">
            ...
            <li class="nav-item">
                <a href="{{ route('frontend.growthStocks') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li class="nav-item">
                <a href="{{ route('frontend.dividendStocks') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
